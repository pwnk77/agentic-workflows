...
specsRouter.post('/', validate({ body: createSpecBodySchema }), asyncHandler(async (req, res) => {
    await specController.createSpec(req, res);
}));
// PUT /api/specs/:id - Update specification
specsRouter.put('/:id', validate({
    params: idParamSchema,
...
specsRouter.delete('/:id', validate({ params: idParamSchema }), asyncHandler(async (req, res) => {
