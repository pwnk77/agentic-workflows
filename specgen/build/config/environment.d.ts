...
declare const environmentSchema: z.ZodObject<{
    ...
    DASHBOARD_PORT: z.ZodDefault<z.ZodNumber>;
    DASHBOARD_AUTO_OPEN: z.ZodDefault<z.ZodString>;
    WEBSOCKET_ENABLED: z.ZodDefault<z.ZodString>;
    WEBSOCKET_PING_INTERVAL: z.ZodDefault<z.ZodNumber>;
    WEBSOCKET_MAX_CONNECTIONS: z.ZodDefault<z.ZodNumber>;
    WEBSOCKET_HEARTBEAT_TIMEOUT: z.ZodDefault<z.ZodNumber>;
}, "strip", z.ZodTypeAny, {
    ...
    DASHBOARD_AUTO_OPEN?: string | undefined;
    WEBSOCKET_ENABLED?: string | undefined;
    WEBSOCKET_PING_INTERVAL?: number | undefined;
    WEBSOCKET_MAX_CONNECTIONS?: number | undefined;
    WEBSOCKET_HEARTBEAT_TIMEOUT?: number | undefined;
}>;
