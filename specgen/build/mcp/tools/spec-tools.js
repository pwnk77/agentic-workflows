 ...
 */
import { createSpecToolSchema, updateSpecToolSchema, listSpecsToolSchema, getSpecToolSchema, deleteSpecToolSchema, searchSpecsToolSchema, getSpecStatsToolSchema, launchDashboardToolSchema } from '../schemas/tool-schemas.js';
    ...
    },
    {
        ...
        handler: async (args) => {
            try {
                ...
                if (updateData.body_md)
                    updateFields.bodyMd = updateData.body_md;
    ...
    },
    {
        ...
        handler: async (args) => {
            try {
                ...
                const spec = await specService.getSpec(validation.data.spec_id, validation.data.include_relations);
                const result = {
                    id: spec.id,
                    title: spec.title,
                    body_md: spec.bodyMd,
        ...
        handler: async (args) => {
            try {
                ...
                const query = {
                    ...
                    sortOrder: validation.data.sort_order.toUpperCase()
                };
