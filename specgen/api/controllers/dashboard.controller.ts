...
export class DashboardController {
   ...
   */
  private async getRecentSpecs(limit: number): Promise<any[]> {
   ...
   */
  private async getActivityStats(): Promise<any> {
    try {
      ...
      logger.error('Failed to calculate activity stats', error as Error);
      return {
